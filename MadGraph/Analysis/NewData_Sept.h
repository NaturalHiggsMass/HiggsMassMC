...
// Tue Sep 25 12:05:16 2018 by ROOT version 6.12/06
// from TTree Delphes/Analysis tree
// found on file: tag_1_delphes_events_Anna.root
//////////////////////////////////////////////////////////

#ifndef NewData_Sept_h
#define NewData_Sept_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 3682;
   static constexpr Int_t kMaxTrack = 120;
   static constexpr Int_t kMaxTower = 241;
   static constexpr Int_t kMaxEFlowTrack = 120;
   static constexpr Int_t kMaxEFlowPhoton = 67;
   static constexpr Int_t kMaxEFlowNeutralHadron = 137;
   ...
   NewData_Sept(TTree *tree=0);
   virtual ~NewData_Sept();
...
#ifdef NewData_Sept_cxx
NewData_Sept::NewData_Sept(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   //TString fileName = "tag_1_delphes_events_Anna.root";
   TString fileName = "/eos/cms/store/user/kropiv/HiggsMass/HiggsGG/root-files/run01_Higgs0or1Jet_PtGen_0_inf_forPtReco_0_80_120GeV.root";
...
//(TFile*)gROOT->GetListOfFiles()->FindObject(fileName.Data());
      if (!f || !f->IsOpen()) {
...
NewData_Sept::~NewData_Sept()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t NewData_Sept::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t NewData_Sept::LoadTree(Long64_t entry)
{
...
void NewData_Sept::Init(TTree *tree)
{
...
void NewData_Sept::Show(Long64_t entry)
{
...
Int_t NewData_Sept::Cut(Long64_t entry)
{
