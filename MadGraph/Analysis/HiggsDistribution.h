...
// Wed Jun 20 16:31:49 2018 by ROOT version 6.12/06
// from TTree Delphes/Analysis tree
// found on file: tag_1_delphes_events.root
//////////////////////////////////////////////////////////

#ifndef HiggsDistribution_h
#define HiggsDistribution_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 1024;
   static constexpr Int_t kMaxTrack = 124;
   static constexpr Int_t kMaxTower = 176;
   static constexpr Int_t kMaxEFlowTrack = 124;
   static constexpr Int_t kMaxEFlowPhoton = 84;
   static constexpr Int_t kMaxEFlowNeutralHadron = 74;
   static constexpr Int_t kMaxGenJet = 11;
   ...
   HiggsDistribution(TTree *tree=0);
   virtual ~HiggsDistribution();
...
#ifdef HiggsDistribution_cxx
HiggsDistribution::HiggsDistribution(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      //TString RootFile = "/Users/Anna/work/HiggsMass/HiggsGammaGammaPt50GeVJet1/Events/run_08/tag_2_delphes_events.root";
      TString RootFile = "/Users/Anna/work/HiggsMass/HiggsGammaGammaPt50GeVJet1/Events/run_09/tag_1_delphes_events.root";
...
HiggsDistribution::~HiggsDistribution()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t HiggsDistribution::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t HiggsDistribution::LoadTree(Long64_t entry)
{
...
void HiggsDistribution::Init(TTree *tree)
{
...
Bool_t HiggsDistribution::Notify()
{
...
void HiggsDistribution::Show(Long64_t entry)
{
...
Int_t HiggsDistribution::Cut(Long64_t entry)
{
...
#endif // #ifdef HiggsDistribution_cxx
