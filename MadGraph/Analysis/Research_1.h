...
#ifdef Research_1_cxx
Research_1::Research_1(TTree *tree) : fChain(0) 
{
...
Int_t Research_1::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Research_1::LoadTree(Long64_t entry)
{
...
void Research_1::Init(TTree *tree)
{
...
void Research_1::Show(Long64_t entry)
{
...
Int_t Research_1::Cut(Long64_t entry)
{
