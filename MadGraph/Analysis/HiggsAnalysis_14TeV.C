...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   Long64_t nentries = fChain->GetEntriesFast();
	...
	//CMS HL-LHC 14 TeV config
        ...
        double XsecD[] =     {16.211, 16.211, 5.7791,  1.3303,  0.69375, 0.34135, 0.10423,  0.049894,  0.010841}; // xsec pb: merge scale 15 
        double Xsec[]  =     {16.467, 16.467, 5.776,   1.3303,  0.69375, 0.34135, 0.10423,  0.049894,  0.010841}; // xsec pb: merge scale 22.5 
        double XsecU[] =     {16.46,  16.46,  5.7471,  1.3303,  0.69372, 0.34135, 0.10423,  0.049894,  0.010841}; // xsec pb: merge scale 30
        double dXsec[] =     {0.0077, 0.0077, 0.0018,  0.00038, 0.0002,  9.7e-05, 2.9e-05,   1.4e-05,   3.1e-06}; // xsec pb: merge scale 22.5 
	//CMS HL-LHC 14 TeV config Mass 123 GeV
        //for reco pT (GeV):     0-120           120-200  200-270  270-350  350-450   450-550   550-750    750-inf 
        double XsecD123[] =     {16.737, 16.737, 5.8759,  1.3425,  0.69758, 0.34356, 0.1044,  0.049999,  0.010814}; // xsec pb: merge scale 15 
        double Xsec123[]  =     {17.116, 17.116, 5.8732,  1.3425,  0.69758, 0.34356, 0.1044,  0.049999,  0.010814}; // xsec pb: merge scale 22.5 
        double XsecU123[] =     {17.1,   17.1,   5.8395,  1.3425,  0.69756, 0.34356, 0.1044,  0.049999,  0.010814}; // xsec pb: merge scale 30
        double dXsec123[] =     {0.008,  0.008,  0.0019,  0.0004,  0.0002,  9.7e-05, 2.9e-05,   1.4e-05,   3.e-06}; // xsec pb: merge scale 22.5 
	//CMS HL-LHC 14 TeV config Mass 127 GeV
        //for reco pT (GeV):     0-120           120-200  200-270  270-350  350-450   450-550   550-750    750-inf 
        double XsecD127[] =     {15.694, 15.694, 5.6525,  1.3165,  0.68982, 0.34084, 0.10425,  0.050083,  0.010839}; // xsec pb: merge scale 15 
        double Xsec127[]  =     {16.048, 16.048, 5.65,    1.3165,  0.68982, 0.34084, 0.10425,  0.050083,  0.010839}; // xsec pb: merge scale 22.5 
        double XsecU127[] =     {16.099, 16.099, 5.6218,  1.3165,  0.68982, 0.34083, 0.10425,  0.050083,  0.010839}; // xsec pb: merge scale 30
        double dXsec127[] =     {0.0075, 0.0075, 0.0018,  0.00038,  0.0002, 9.7e-05, 2.9e-05,   1.4e-05,  3.1e-06}; // xsec pb: merge scale 22.5 

        double XsecD_BG[] =  {16.785, 4.2462,  1.6333,  0.21467, 0.081482, 0.018815, 0.0067266, 0.0025066, 0.00025174};
	double Xsec_BG[]  =  {16.946, 4.2458,  1.6333,  0.21467, 0.081482, 0.018815, 0.0067266, 0.0025066, 0.00025174};
	double XsecU_BG[] =  {16.829, 4.2405,  1.6332,  0.21467, 0.081482, 0.018815, 0.0067266, 0.0025066, 0.00025174};
        double dXsec_BG[] =  {0.0053, 0.0012,  0.00046, 6.e-05,  2.3e-05,  5.3e-06,  1.9e-06,   7e-07,     7.1e-08};
	...
	legData->Draw("same");
        ...
        if(DataSample == "Signal") Can_Eff->Print(Form("Plots/mH%3.0f_Eff.png",massHiggs));
	else Can_Eff->Print("Plots/BG_Eff.png");
